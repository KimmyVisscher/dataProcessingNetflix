...
ALTER TABLE Preference ADD CONSTRAINT PK_Preference PRIMARY KEY (preference_id,watchlist_item_id);
...
ALTER TABLE Preference ADD CONSTRAINT FK_Preference_0 FOREIGN KEY (watchlist_item_id) REFERENCES viewing_behavior (watchlist_item_id);
...
ALTER TABLE Profile ADD CONSTRAINT FK_Profile_1 FOREIGN KEY (preference_id,watchlist_item_id) REFERENCES Preference (preference_id,watchlist_item_id);
...
ALTER TABLE characteristics ADD CONSTRAINT FK_characteristics_0 FOREIGN KEY (episode_id,serie_id) REFERENCES Episode (episode_id,serie_id);
